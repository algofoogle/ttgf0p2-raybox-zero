...
#ANTON: This is an attemp to ignore all timing paths that pass through the reciprocal combo block
# inside rcp_fsm. We assume its outputs are always valid when used.
# set_false_path -through rbzero.wall_tracer.rcp_fsm.*
set_false_path -through rbzero.wall_tracer.rcp_fsm.operand*
